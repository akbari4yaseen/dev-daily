  ...
  <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    <div className="relative shadow-md inline-block w-full h-60 lg:h-80 mb-6">
      <Image
        ...
        alt={post.title}
        className="shadow-lg h-80 object-cover w-full rounded-t-lg lg:rounded-lg"
        layout="fill"
      />
    </div>
    ...
    <div className="block text-center items-center justify-center mb-8 w-full lg:flex">
      <div className="flex items-center justify-center mb-4 mr-8 w-full lg:w-auto lg:mb-0 ">
        <Image
          unoptimized
          loader={grpahCMSImageLoader}
